...
from MCEP.agents import AWACLearner
...
config_flags.DEFINE_config_file(
    "config",
    "configs/offline_config.py:awac_mujoco",
...
def main(_):
    wandb.init(project=f"MCEP_offline_AWAC-{FLAGS.config.model_config.awac_lambda}",
               group=f"awac-{FLAGS.env_name}",
               name=str(FLAGS.seed))
