...
config_flags.DEFINE_config_file(
    "config",
    "configs/offline_config.py:td3bcep_mujoco",
...
def main(_):
    wandb.init(project=f"MCEP_offline_td3bcep_{FLAGS.config.model_config.bp_alpha}-{FLAGS.config.model_config.tp_alpha}",
