...
config_flags.DEFINE_config_file(
    "config",
    "configs/offline_config.py:awacep_mujoco",
...
def main(_):
    wandb.init(project=f"MCEP_offline_AWACEP-{FLAGS.config.model_config.tilde_lambda}-{FLAGS.config.model_config.evaluation_lambda}",
